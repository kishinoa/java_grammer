...
//        replaceAll(a,b) : replace와 사용법 동일, 정규표현식을 쓸 수 있는점이 차이점
//        String st1 = "01abC123한글123";
//        소문자 알파벳 제거
//        System.out.println(st1.replaceAll("[a-z]",""));
//        System.out.println(st1.replaceAll("[A-Za-z]",""));
//        System.out.println(st1.replaceAll("[가-히]",""));
...
//        String st1 = "hello";
//        StringBuilder는 동시성 이슈 O == Thread-Safe하지 않음
//        StringBuilder sb = new StringBuilder();
//        StringBuffer는 동시성 이슈 X == Thread-Safe함
//        StringBuffer sb2 = new StringBuffer();

//        문자열을 더해서 출력해주는 프로그램
//        A : hello, java   B : hello, C++
